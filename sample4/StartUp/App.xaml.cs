...
namespace Sample4
{
    ...
    public partial class App : PrismApplication
    {
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
            => containerRegistry.Register<Models.IHeavyWorker, Models.IHeavyWorker>();
        ...
        protected override void ConfigureViewModelLocator()
        {
            ...
            ViewModelLocationProvider.Register<StartUp.Views.MainWindow, StartUp.ViewModels.MainWindow>();
